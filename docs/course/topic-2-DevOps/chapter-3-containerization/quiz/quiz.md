...
<div id="quiz">
    ...
    <div id="intro-page">
        <header>
            <div class="chapter-name">Chapter 3 - Containerization</div>
        </header>
        
        <div class="container">
            <p>This quiz covers the key concepts from Chapter 3 - Containerization</p>
            <p>You'll be tested on:</p>
            <ul>
                <li>The definition and purpose of containers in cloud computing</li>
                <li>Key benefits such as portability, scalability, and fault tolerance</li>
                <li>How containerization supports microservices and IoT use cases</li>
                <li>The roles of artifacts and tools like Artifactory and Kubernetes</li>
            </ul>
        </div>
    ...
    <div id="quiz-complete" class="quiz-complete hidden">
        ...
        <div>
            ...
            <button id="next-chapter" class="quiz-btn" onclick="window.location.href='../../chapter-4-webhooks/index'">Next Chapter</button>
        </div>
    </div>
    ...
    <script type='module'>
        ...
        function completeQuiz() {
            ...
            onAuthStateChanged(auth, (user) => {
                if (user) {
                    const quizRef = ref(db, "users/" + user.uid + "/" + "Containerization");
